...
#define rs o[p].r
    ...
    void mark(int p, ll ad, ll mu) { (o[p].v *= mu) += ad; o[p].mu *= mu; o[p].ad *= mu; o[p].ad += ad; }
    void down(int p) { if (o[p].ad || o[p].mu ^ 1) mark(ls, o[p].ad, o[p].mu), mark(rs, o[p].ad, o[p].mu), o[p].ad = 0, o[p].mu = 1; }
